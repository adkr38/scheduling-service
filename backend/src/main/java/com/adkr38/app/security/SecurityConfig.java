...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(HttpMethod.GET,"/api/appointment/all").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.GET,"/api/appointment/availability").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
